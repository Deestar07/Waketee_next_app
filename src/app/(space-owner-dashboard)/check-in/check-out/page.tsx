...
export default function CheckOut() {
  ...
  const [checkoutBookingCode, setCheckoutBookingCode] = useState<string>('');
  const closeModal = () => {
        ...
        >
          ...
          <div className={`space-y-5`}>
            ...
            <input
              ...
              placeholder='ABC123'
              type='text'
              value={checkoutBookingCode}
              onChange={(e) => setCheckoutBookingCode(e.target.value)}
            />
